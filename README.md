...
**Package:** `@loanpro/devex-workflow-framework` v0.3.1
...
| `devex upgrade --workflow-version v0.3.1` | Update the pinned framework ref across `devex.yaml` and the caller workflow |
...
│                    │                                            │
└────────────────────┼────────────────────────────────────────────┘
                     │ uses: loanprochallenge/.github/workflows/pr.yml@v0.3.1
                     ▼
┌─────────────────────────────────────────────────────────────────┐
...
workflowVersion:
  ref: v0.3.1                      # must be a semver tag or 40-char SHA
```
