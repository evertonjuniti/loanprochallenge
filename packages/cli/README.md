...
--workflow-ref       Workflow framework version tag (e.g. v0.3.0)
...
devex upgrade --workflow-version v0.3.0 --dry-run  # preview changes only
```
...
workflowVersion:
  ref: v0.3.0                    # must be a semver tag or full 40-char SHA
```
